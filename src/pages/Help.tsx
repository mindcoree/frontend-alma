      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Наши опытные эдвайзеры готовы помочь вам с любыми вопросами по обучению и развитию
          </p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 mb-12 border border-white/20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-6 rounded-xl text-white relative overflow-hidden">
              ...
              <p className="text-blue-100 text-sm">Сб: 10:00 - 14:00</p>
            </div>
            <div className="bg-gradient-to-br from-green-500 to-green-600 p-6 rounded-xl text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -translate-y-10 translate-x-10"></div>
              <PhoneIcon className="h-8 w-8 mb-4" />
              <h3 className="font-semibold text-lg mb-2">Телефон</h3>
              <p className="text-green-100">+7 (727) 123-45-67</p>
              <p className="text-green-100 text-sm">Горячая линия</p>
            </div>
            <div className="bg-gradient-to-br from-purple-500 to-purple-600 p-6 rounded-xl text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -translate-y-10 translate-x-10"></div>
              <EnvelopeIcon className="h-8 w-8 mb-4" />
              <h3 className="font-semibold text-lg mb-2">Email</h3>
              <p className="text-purple-100">support@alma.edu.kz</p>
              <p className="text-purple-100 text-sm">24/7 поддержка</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredAdvisors.map((advisor) => (
              <div
                key={advisor.id}
                className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-white/20 group"
              >
                <div className="p-6">
                  {/* Header карточки */}
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-4 sm:p-8 mb-8 border border-white/20">
          ...
          <div className="space-y-3 sm:space-y-4 lg:space-y-6">
            {(showFAQ ? faqItems : faqItems.slice(0, 3)).map((faq) => (
              <div
                key={faq.id}
                className="border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow bg-gradient-to-br from-slate-50 to-white group"
              >
                <button
